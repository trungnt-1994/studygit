...
#              mkfs.fat command: create an MS-DOS filesystem under Linux
#              fsck.fat command: check and repair MS-DOS filesystems
#              fatlabel command: set or get a MS-DOS filesystem label
#              from a given device
#=======================================================================
